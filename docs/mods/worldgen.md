...
1. JourneyMap으로 이미 생성된 영역의 경계를 확인합니다.
2. 장거리 이동 전 귀환 지점, 식량, 무덤 회수 방법을 준비합니다.
3. 새 청크에서 지형 변화와 구조물을 찾고 웨이포인트를 남깁니다.
4. 구조물은 함정/적대 몹 가능성을 고려해 입구와 탈출로부터 확인합니다.
5. 이상 지형은 좌표, 시드 공개 가능 여부, 새/기존 청크 여부를 함께 기록합니다.
...
[탐험 & 월드](/guide/exploration) · [Friends&Foes](/mods/friends-and-foes) · [생존 & 죽음](/guide/survival)
